...
class ProjectCard extends React.Component {
  ...
  render () {
    ...
    this.props.project.photo !== undefined
      ? image = this.props.project.photo
      : image = fillercardimage
    style = { height: 350, width: 300, backgroundImage: `url(${image})` }
    ...
    return (
      ...
      >
        { this.state.cardClicked
          ...
          : <b><p style={{fontFamily: font1, color: 'white', fontSize: 20, marginTop: 230, marginLeft: 10}}>{this.props.project.name}</p></b>
        }
      </Card>
    )
  }
