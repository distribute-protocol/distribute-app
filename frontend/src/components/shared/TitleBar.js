...
export default ({
  ...
  return (
    <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 55, backgroundColor: roleColor}}>
      <b><p style={{paddingTop: 20, paddingLeft: 75, color: 'white', fontFamily: 'Lato', fontSize: 28}}>{role}</p></b>
