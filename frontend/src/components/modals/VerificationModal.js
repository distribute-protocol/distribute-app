      ...
      case 'verification':
        ...
        bottomText = <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly', alignItems: 'center', paddingTop: 39, color: 'black'}}>
          ...
          <div style={{display: 'flex', minWidth: '100%', justifyContent: 'space-evenly', marginTop: -20}}>
            <Button style={{borderRadius: 4, color: '#989898', backgroundColor: 'white', maxWidth: 200, height: 55, fontSize: 30, fontFamily: 'Lato', textAlign: 'center'}} key='continueclout' onClick={this.props.handleVerifyCancel}>
              <b>Cancel</b>
            </Button>
        ...
        break
      case 'pending':
        topText = <div style={{display: 'flex', justifyContent: 'space-around', color: 'black'}}><img style={{cursor: 'pointer'}} src={cancel} alt={cancel} onClick={this.props.handleVerifyCancel} /><p style={{marginTop: 15, fontFamily: 'Avenir Next', fontSize: 30, fontWeight: 500, justifyContent: 'center'}}>You are initiating a proposal with the following details:</p></div>
        ...
        break
      case 'txConfirmed':
        topText = <div style={{display: 'flex', justifyContent: 'space-between', color: 'black'}}><img style={{cursor: 'pointer'}} src={cancel} alt={cancel} onClick={this.props.handleVerifyCancel} /><p style={{marginTop: 15, fontFamily: 'Avenir Next', fontSize: 30, fontWeight: 500}}>Success!</p><p /></div>
        ...
        break
      case 'txFailed':
        topText = <div style={{display: 'flex', justifyContent: 'space-between', color: 'black'}}><img style={{cursor: 'pointer', justifyContent: 'flex-start'}} src={cancel} alt={cancel} onClick={this.props.handleVerifyCancel} /><p style={{marginTop: 15, fontFamily: 'Avenir Next', fontSize: 30, fontWeight: 500, justifyContent: 'center'}}>Failed</p><p /></div>
        bottomText = <div style={{display: 'flex', flexDirection: 'column', justifyContent: 'space-evenly', alignItems: 'center', color: 'black', paddingTop: 20}}>
          ...
          <Button style={{marginTop: 10, borderRadius: 4, border: '1px solid rgba(0, 0, 0, 0.6)', color: 'rgba(0, 0, 0, 0.6)', maxWidth: 200, height: 45, fontSize: 24, fontFamily: 'Lato', textAlign: 'center'}} key='continuemoney' onClick={this.props.handleVerifyCancel}>
            Close
          </Button>
        </div>
        backColor = 'rgba(126, 211, 33, 0.25)'
